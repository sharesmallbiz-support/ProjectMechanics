...
import ControlPanel from '../workflow/ControlPanel';
import OutputViewer from '../workflow/OutputViewer';
import CritiqueModal from '../workflow/CritiqueModal';
            ...
            <p>
              {import.meta.env.DEV ? (
                ...
                <span className="text-gray-500">
                  Connected to Document Agent API
                </span>
              )}
            </p>
          </div>
