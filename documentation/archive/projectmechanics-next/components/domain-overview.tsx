...
export function DomainOverview() {
  const domains = [
    ...
    },
    {
      ...
      description: "Explore specialized areas of project management including portfolio management, change management, and conflict resolution.",
      features: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto" data-testid="text-domain-description">
            Project Mechanics is a static educational resource providing structured project management frameworks and practical knowledge — 
            built on experience, shared openly. No login required, no data collection, just pure knowledge.
          </p>
        </div>
