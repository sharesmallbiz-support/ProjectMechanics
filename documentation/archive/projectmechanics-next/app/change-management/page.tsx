...
export const metadata: Metadata = generatePageMetadata("changeManagement");
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h1
              ...
              data-testid="text-change-management-hero-title"
            >
            ...
            <p
              ...
              data-testid="text-change-management-hero-description"
            >
              Navigate organizational transformation successfully through
              structured change management processes and stakeholder engagement
              strategies.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p
              ...
              data-testid="text-framework-description"
            >
              A structured approach to managing organizational change that
              addresses both the technical and human aspects of transformation.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <Card className="bg-card rounded-xl p-8 border border-border text-center">
              <CardContent className="p-0">
                ...
                <h3
                  ...
                  data-testid="text-process-focus-title"
                >
                  Process Focus
                </h3>
                <p
                  className="text-muted-foreground"
                  data-testid="text-process-focus-description"
                >
                  Structured methodology for implementing change initiatives with
            ...
            <Card className="bg-card rounded-xl p-8 border border-border text-center">
              <CardContent className="p-0">
                ...
                <h3
                  className="text-xl font-bold mb-4"
                  data-testid="text-people-focus-title"
                >
                  People Focus
                </h3>
                <p
                  className="text-muted-foreground"
                  data-testid="text-people-focus-description"
                >
                  Address the human side of change through communication,
            ...
            <Card className="bg-card rounded-xl p-8 border border-border text-center">
              <CardContent className="p-0">
                ...
                <h3
                  className="text-xl font-bold mb-4"
                  data-testid="text-results-focus-title"
                >
                  Results Focus
                </h3>
                <p
                  className="text-muted-foreground"
                  data-testid="text-results-focus-description"
                >
                  Measure and track change adoption to ensure objectives are met
            ...
            {[
              {
                ...
                description:
                  "Evaluate the organization's readiness for change and identify potential barriers and enablers.",
                activities: [
              ...
              },
              {
                ...
                description:
                  "Develop a comprehensive change management strategy aligned with project objectives.",
                activities: [
              ...
              },
              {
                ...
                description:
                  "Identify and engage key stakeholders and change champions throughout the organization.",
                activities: [
                  "Sponsor engagement",
              ...
              },
              {
                ...
                description:
                  "Create detailed plans for communication, training, and change implementation activities.",
                activities: [
                  "Communication plan",
                  "Training plan",
              ...
              },
              {
                ...
                description:
                  "Execute the change plan while monitoring progress and adjusting as needed.",
                activities: [
              ...
              },
              {
                step: "Sustain Change",
                description:
                  "Reinforce new behaviors and processes to ensure long-term adoption and success.",
                activities: [
                      ...
                      <div className="space-y-2">
                        {step.activities.map((activity, activityIndex) => (
                          <div
                            ...
                            data-testid={`step-activity-${index}-${activityIndex}`}
                          >
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2
              className="text-3xl lg:text-4xl font-bold mb-6"
              data-testid="text-success-factors-title"
            >
