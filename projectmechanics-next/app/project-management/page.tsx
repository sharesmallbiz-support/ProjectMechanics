...
export const metadata: Metadata = generatePageMetadata("projectManagement");
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h1
              ...
              data-testid="text-project-management-hero-title"
            >
            ...
            <p
              ...
              data-testid="text-project-management-hero-description"
            >
              Master the fundamental principles of project management, from
              initiation through closure, using proven methodologies and best
              practices.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2
              ...
              data-testid="text-core-principles-title"
            >
              Core Project Management Principles
            </h2>
            <p
              className="text-lg text-muted-foreground max-w-4xl mx-auto mb-12"
              data-testid="text-core-principles-description"
            >
              Effective project management relies on fundamental principles that
              guide successful project execution from start to finish.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <Card className="bg-card rounded-xl p-8 border border-border">
              <CardContent className="p-0">
                <h3
                  ...
                  data-testid="text-planning-title"
                >
                  Project Planning & Initiation
                </h3>
                <p
                  className="text-muted-foreground mb-6"
                  data-testid="text-planning-description"
                >
                  Proper planning sets the foundation for project success. This
                  includes defining scope, objectives, timelines, and resource
                  requirements.
                </p>
            ...
            <Card className="bg-card rounded-xl p-8 border border-border">
              <CardContent className="p-0">
                ...
                <p
                  className="text-muted-foreground mb-6"
                  data-testid="text-execution-description"
                >
                  Successful execution requires continuous monitoring,
                  communication, and adaptive management to keep projects on
                  track.
                </p>
                <div className="space-y-3">
                  <div className="flex items-center">
      ...
      <section className="py-20 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2
              className="text-3xl lg:text-4xl font-bold mb-6"
              data-testid="text-project-phases-title"
            >
              Project Management Phases
            </h2>
            <p
              className="text-lg text-muted-foreground max-w-4xl mx-auto mb-12"
              data-testid="text-project-phases-description"
            >
              Every successful project follows a structured approach through
            ...
            {[
              {
                phase: "Initiation",
                description:
                  "Define project purpose, objectives, and high-level scope. Identify stakeholders and obtain project authorization.",
                keyActivities: [
              ...
              },
              {
                phase: "Planning",
                description:
                  "Develop comprehensive project plans, including scope, schedule, budget, quality, resources, and communication plans.",
                keyActivities: [
              ...
              },
              {
                phase: "Execution",
                description:
                  "Coordinate people and resources to carry out the project plan and produce deliverables.",
                keyActivities: [
                  "Team management",
                  "Quality assurance",
              ...
              },
              {
                ...
                description:
                  "Track, review, and regulate project progress and performance to identify variances from the project plan.",
                keyActivities: [
              ...
              },
              {
                phase: "Closure",
                description:
                  "Finalize all project activities, complete deliverables, and formally close the project.",
                keyActivities: [
              ...
              <Card
                ...
                data-testid={`project-phase-${index}`}
              >
                <CardContent className="p-0">
                  <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    <div>
                      <p
                        ...
                        data-testid={`phase-description-${index}`}
                      >
                        {phase.description}
                      </p>
                    </div>
                      ...
                      <div className="space-y-2">
                        {phase.keyActivities.map((activity, activityIndex) => (
                          <div
                            ...
                            data-testid={`phase-activity-${index}-${activityIndex}`}
                          >
