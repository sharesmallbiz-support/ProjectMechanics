...
import { Palette, Cog, Youtube, Award, Users, Check } from "lucide-react";
import { METHODOLOGY_CONTENT, YOUTUBE_VIDEO_ID } from "@/lib/constants";
import { generateMetadata as generatePageMetadata } from "@/lib/metadata";

export const metadata: Metadata = generatePageMetadata("methodology");
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1
              ...
              data-testid="text-methodology-hero-title"
            >
              Project Management{" "}
              <span className="text-yellow-300">Methodology</span>
            </h1>
            <p
              className="text-lg lg:text-xl opacity-90 mb-8 leading-relaxed max-w-4xl mx-auto"
              data-testid="text-methodology-hero-description"
            >
            ...
            <div className="mt-12 max-w-5xl mx-auto">
              <p
                ...
                data-testid="text-explore-sections"
              >
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                  <Badge
                    ...
                    data-testid="badge-podcast"
                  >
                    Featured Content
                  </Badge>
                  <h3
                    className="text-3xl font-bold mb-4"
                    data-testid="text-methodology-podcast-title"
                  >
                    Deep Dive: Project Mechanics Podcast
                  </h3>
                  <p
                    className="text-muted-foreground mb-6 text-lg"
                    data-testid="text-methodology-podcast-description"
                  >
                    Join Mark Hazleton and the deep dive podcast team in their
                    comprehensive discussion on Project Mechanics. Explore both
                    the art and the science behind successful project execution
                    with real-world examples and practical insights.
                  </p>
                    ...
                    <div className="flex items-center">
                      ...
                      <div>
                        <p
                          ...
                          data-testid="text-methodology-author-name"
                        >
                          Mark Hazleton
                        </p>
                        <p
                          className="text-sm text-muted-foreground"
                          data-testid="text-methodology-author-subscribers"
                        >
                          24 subscribers
                        </p>
                      </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {benefitsOfConsistency.advantages.map((advantage, index) => (
              <div
                key={index}
                className="flex items-start"
                data-testid={`consistency-advantage-${index}`}
              >
                <Check className="text-green-600 mr-3 h-5 w-5 mt-1" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto mb-16">
            <div>
              <h2
                className="text-3xl lg:text-4xl font-bold mb-6"
                data-testid="text-art-science-title"
              >
                {artVsScience.title}
              </h2>
              <p
                className="text-lg text-muted-foreground mb-8"
                data-testid="text-art-science-description"
              >
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4
                      ...
                      data-testid="text-art-title"
                    >
                      The Art: Communication
                    </h4>
                    <p
                      className="text-muted-foreground"
                      data-testid="text-art-description"
                    >
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p
                      className="text-muted-foreground"
                      data-testid="text-science-description"
                    >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2
              ...
              data-testid="text-constituencies-main-title"
            >
              Three Key Constituencies
            </h2>
            <p
              className="text-lg text-muted-foreground max-w-3xl mx-auto"
              data-testid="text-constituencies-main-description"
            >
              Effective communication with these three groups is essential for
              project success in any service delivery environment.
            </p>
          </div>
              ...
              >
                <CardContent className="p-0">
                  <h3
                    ...
                    data-testid={`text-constituency-detailed-${constituency.name.toLowerCase()}-name`}
                  >
                    {constituency.name}
                  </h3>
                  <p
                    className="text-muted-foreground text-lg"
                    data-testid={`text-constituency-detailed-${constituency.name.toLowerCase()}-description`}
                  >
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p
              className="text-lg text-muted-foreground max-w-4xl mx-auto mb-12"
              data-testid="text-lifecycle-description"
            >
          ...
          <div className="grid lg:grid-cols-2 gap-12 mb-20">
            <div className="text-center">
              <h3
                ...
                data-testid="text-lifecycle-states-diagram"
              >
            ...
            <div className="text-center">
              <h3
                className="text-2xl font-bold mb-6"
                data-testid="text-lifecycle-sequence-diagram"
              >
          ...
          <div className="space-y-8">
            {projectLifeCycle.states.map((state, index) => (
              <Card
                ...
                data-testid={`lifecycle-state-${index}`}
              >
                <CardContent className="p-0">
                  <div className="grid lg:grid-cols-3 gap-8">
                    <div>
                        ...
                        <div>
                          ...
                          {state.keyQuestion && (
                            <p
                              ...
                              data-testid={`state-question-${index}`}
                            >
                              &quot;{state.keyQuestion}&quot;
                            </p>
                          )}
                      ...
                      <p
                        ...
                        data-testid={`state-status-${index}`}
                      >
                        {state.status}
                      </p>
                    </div>
                    ...
                    <div className="lg:col-span-2">
                      <p
                        ...
                        data-testid={`state-description-${index}`}
                      >
                        {state.description}
                      </p>
                          ...
                          <div className="space-y-2">
                            {state.keyPoints.map((point, pointIndex) => (
                              <div
                                ...
                                data-testid={`state-keypoint-${index}-${pointIndex}`}
                              >
                      ...
                      {state.deliverable && (
                        <div className="bg-muted/50 p-4 rounded-lg border-l-4 border-primary">
                          ...
                          <p
                            className="text-muted-foreground"
                            data-testid={`state-deliverable-${index}`}
                          >
                            {state.deliverable}
                          </p>
                        </div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2
              className="text-3xl lg:text-4xl font-bold mb-6"
              data-testid="text-kickoff-title"
            >
              {kickOffMeeting.title}
            </h2>
            <p
              className="text-lg text-muted-foreground max-w-4xl mx-auto mb-12"
              data-testid="text-kickoff-description"
            >
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {kickOffMeeting.agenda.map((item, index) => (
              <div
                key={index}
                className="flex items-start"
                data-testid={`kickoff-agenda-${index}`}
              >
                <Check className="text-green-600 mr-3 h-5 w-5 mt-1" />
              ...
              <CardContent className="p-0">
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    <h3
                      className="text-2xl font-bold"
                      data-testid="text-pmi-methodology-title"
                    >
                      {pmiFramework.title}
                    </h3>
                    <p className="text-muted-foreground">
                      Professional alignment with industry standards
                    </p>
                  </div>
                </div>
                <blockquote className="bg-muted/50 p-6 rounded-lg border-l-4 border-primary mb-6">
                  <p
                    ...
                    data-testid="text-pmi-methodology-quote"
                  >
                    &quot;{pmiFramework.quote}&quot;
                  </p>
                ...
                <div className="space-y-3">
                  {pmiFramework.processes.map((process, index) => (
                    <div
                      key={index}
                      className="flex items-center"
                      data-testid={`pmi-methodology-process-${index}`}
                    >
            ...
            <Card className="bg-card rounded-xl p-8 border border-border">
              <CardContent className="p-0">
                ...
                <div className="space-y-4">
                  ...
                  >
                    Project Mechanics is built on the foundation of clear
                    communication, efficient planning, and agile response to
                    change. It emphasizes understanding project scope
                    thoroughly, managing resources efficiently, and maintaining
