...
export const metadata: Metadata = generatePageMetadata("portfolioManagement");
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h1
              ...
              data-testid="text-portfolio-management-hero-title"
            >
            ...
            <p
              ...
              data-testid="text-portfolio-management-hero-description"
            >
              Comprehensive Program Management Office (PMO) framework combining
              strategic portfolio management with client delivery excellence and
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2
              ...
              data-testid="text-ppm-overview-title"
            >
              Project Portfolio Management Overview
            </h2>
            <p
              className="text-lg text-muted-foreground max-w-4xl mx-auto mb-12"
              data-testid="text-ppm-overview-description"
            >
              Project Portfolio Management (PPM) is a strategic approach that
              organizations use to prioritize, select, and manage a collection of
              projects and programs as a unified portfolio.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <Card className="bg-card rounded-xl p-8 border border-border text-center">
              <CardContent className="p-0">
                ...
                <h3
                  ...
                  data-testid="text-strategic-alignment-title"
                >
                  Strategic Alignment
                </h3>
                <p
                  className="text-muted-foreground"
                  data-testid="text-strategic-alignment-description"
                >
                  Ensure all projects align with organizational goals and
                  strategic objectives for maximum impact.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-card rounded-xl p-8 border border-border text-center">
              <CardContent className="p-0">
                ...
                <h3
                  className="text-xl font-bold mb-4"
                  data-testid="text-value-optimization-title"
                >
                  Value Optimization
                </h3>
                <p
                  className="text-muted-foreground"
                  data-testid="text-value-optimization-description"
                >
                  Maximize return on investment through careful selection and
            ...
            <Card className="bg-card rounded-xl p-8 border border-border text-center">
              <CardContent className="p-0">
                ...
                <h3
                  className="text-xl font-bold mb-4"
                  data-testid="text-resource-optimization-title"
                >
                  Resource Optimization
                </h3>
                <p
                  className="text-muted-foreground"
                  data-testid="text-resource-optimization-description"
                >
                  Efficiently allocate resources across projects to prevent
      ...
      <section className="py-20 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2
              className="text-3xl lg:text-4xl font-bold mb-6"
              data-testid="text-key-components-title"
            >
          ...
          <div className="space-y-8">
            {[
              ...
              <Card
                ...
                data-testid={`portfolio-component-${index}`}
              >
                <CardContent className="p-0">
                  <div className="grid lg:grid-cols-3 gap-8">
                    <div>
                      <h3
                        ...
                        data-testid={`component-title-${index}`}
                      >
                        {component.title}
                      </h3>
                    </div>
                    ...
                    <div>
                      <p
                        ...
                        data-testid={`component-description-${index}`}
                      >
                      ...
                      <div className="space-y-2">
                        {component.components.map((item, itemIndex) => (
                          <div
                            ...
                            data-testid={`component-item-${index}-${itemIndex}`}
                          >
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2
              className="text-3xl lg:text-4xl font-bold mb-6"
              data-testid="text-pmo-structure-title"
            >
              Program Management Office Structure
            </h2>
            <p
              className="text-lg text-muted-foreground max-w-4xl mx-auto mb-12"
              data-testid="text-pmo-structure-description"
            >
              A centralized operations unit providing defined organization rather
              than temporary project teams, partnering with client management
            ...
            <Card className="bg-card rounded-xl p-8 border border-border">
              <CardContent className="p-0">
                <h3
                  ...
                  data-testid="text-org-chart-title"
                >
                ...
                <div className="grid lg:grid-cols-3 gap-6 mb-8">
                  <Card className="bg-primary/5 border-primary/20 text-center p-6">
                    <CardContent className="p-0">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Pursuit leadership, C-Level contact, Contract negotiation
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="bg-primary/5 border-primary/20 text-center p-6">
                    <CardContent className="p-0">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Project estimation, delivery oversight, P&L management
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="bg-green-50 border-green-200 inline-block p-6">
                    <CardContent className="p-0">
                      ...
                      <p className="text-sm text-green-700">
                        Day-to-day client satisfaction, task delivery coordination
                      </p>
                    </CardContent>
                  </Card>
                </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
                  {[
                    ...
                    <Card
                      key={index}
                      className="bg-blue-50 border-blue-200 text-center p-4"
                    >
                      <CardContent className="p-0">
      ...
      <section className="py-20 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2
              className="text-3xl lg:text-4xl font-bold mb-6"
              data-testid="text-account-management-title"
            >
              Digital Account Management
            </h2>
            <p
              className="text-lg text-muted-foreground max-w-4xl mx-auto mb-12"
              data-testid="text-account-management-description"
            >
              The ability to keep clients consistently happy, own the account,
              care about the client, and know what they need while constantly
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-16">
            ...
            <Card className="bg-card rounded-xl p-8 border border-border">
              <CardContent className="p-0">
                <h3
                  className="text-2xl font-bold mb-6"
                  data-testid="text-role-responsibilities-title"
                >
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2
              className="text-3xl lg:text-4xl font-bold mb-6"
              data-testid="text-skill-set-title"
            >
                ...
                <CardContent className="p-0">
                  ...
                  <div className="space-y-3">
                    {skillGroup.skills.map((skill, skillIndex) => (
                      ...
                      >
                        <Check
                          className={`text-${skillGroup.color}-600 mr-3 h-4 w-4 mt-0.5`}
                        />
                        <span className="text-muted-foreground text-sm">
                          {skill}
                        </span>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            <Card className="bg-card rounded-xl p-8 border border-border">
              <CardContent className="p-0">
                ...
                <h3
                  className="text-xl font-bold mb-4"
                  data-testid="text-internal-skills-title"
                >
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div
                      key={index}
                      className="flex items-start"
                      data-testid={`internal-skill-${index}`}
                    >
            ...
            <Card className="bg-card rounded-xl p-8 border border-border">
              <CardContent className="p-0">
                ...
                <h3
                  className="text-xl font-bold mb-4"
                  data-testid="text-passion-title"
                >
                  Great Digital Account Management
                </h3>
                <blockquote className="text-lg italic text-muted-foreground mb-6">
                  &quot;A burning passion for all things web. They live and
                  breathe it, during the day and when they go home – they
                  absolutely love it and can&apos;t get enough.&quot;
                </blockquote>
                <div className="space-y-3">
                  {[
                    ...
                    <div
                      key={index}
                      className="flex items-start"
                      data-testid={`passion-trait-${index}`}
                    >
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2
              className="text-3xl lg:text-4xl font-bold mb-6"
              data-testid="text-structured-process-title"
            >
              Structured Process Implementation
            </h2>
            <p
              className="text-lg text-muted-foreground max-w-4xl mx-auto mb-12"
              data-testid="text-structured-process-description"
            >
              Following structured processes prevents over-selling, under-quoting,
              and missing critical requirements that result in costly fixes.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-16">
            <Card className="bg-card rounded-xl p-8 border border-border">
              <CardContent className="p-0">
                <h3
                  className="text-2xl font-bold mb-6"
                  data-testid="text-process-ideas-title"
                >
                  Process Implementation Ideas
                </h3>
                <div className="space-y-4">
                  {[
                    ...
                    <div
                      key={index}
                      className="flex items-start"
                      data-testid={`process-idea-${index}`}
                    >
                      <Check className="text-green-600 mr-3 h-5 w-5 mt-0.5" />
                ...
                <div className="space-y-6">
                  {[
                    ...
                    },
                    {
                      ...
                      description:
                        "Comprehensive client information filled by account managers",
                    },
                    {
                      title: "Monthly Client Contact Report",
                      description:
                        "Call details, social shares, email correspondence, opportunities identified",
                    },
      ...
      <section className="py-20 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2
              className="text-3xl lg:text-4xl font-bold mb-6"
              data-testid="text-sales-delivery-title"
            >
            ...
            <CardContent className="p-0">
              <div className="space-y-8">
                {[
                  ...
                  >
                    <div
                      className={`bg-${step.color}-100 p-3 rounded-full w-12 h-12 flex items-center justify-center`}
                    >
                    ...
                    <div className="flex-1">
                      <div className="grid lg:grid-cols-3 gap-4">
                        ...
                        <div>
                          <span
                            className={`inline-block px-3 py-1 rounded-full text-xs font-medium bg-${step.color}-100 text-${step.color}-800`}
                          >
                            {step.focus}
                          </span>
                        </div>
